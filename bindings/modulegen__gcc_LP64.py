...
def register_types(module):
    ...
    ## aodv-helper.h (module 'aodv'): ns3::AodvTrustHelper [class]
    module.add_class('AodvTrustHelper', parent=root_module['ns3::Ipv4RoutingHelper'])
...
def register_methods(root_module):
    ...
    register_Ns3AodvHelper_methods(root_module, root_module['ns3::AodvTrustHelper'])
...
def register_Ns3AodvHelper_methods(root_module, cls):
    ## aodv-helper.h (module 'aodv'): ns3::AodvTrustHelper::AodvHelper(ns3::AodvTrustHelper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::AodvTrustHelper const &', 'arg0')])
    ## aodv-helper.h (module 'aodv'): ns3::AodvTrustHelper::AodvHelper() [constructor]
    cls.add_constructor([])
    ## aodv-helper.h (module 'aodv'): int64_t ns3::AodvTrustHelper::AssignStreams(ns3::NodeContainer c, int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('ns3::NodeContainer', 'c'), param('int64_t', 'stream')])
    ## aodv-helper.h (module 'aodv'): ns3::AodvTrustHelper * ns3::AodvTrustHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::AodvTrustHelper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aodv-helper.h (module 'aodv'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::AodvTrustHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## aodv-helper.h (module 'aodv'): void ns3::AodvTrustHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    return
