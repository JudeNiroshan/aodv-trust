...
void RoutingProtocol::UpdateRouteToNeighbor(Ipv4Address sender,
	...
	std::vector<TrustTableEntry> &existingTrustTableEntries =
			m_trustTable.getTrustTableEntries();

	for (std::vector<TrustTableEntry>::iterator it =
			existingTrustTableEntries.begin();
			it != existingTrustTableEntries.end(); it++) {
...
void RoutingProtocol::RecvReply(Ptr<Packet> p, Ipv4Address receiver,
	...
	RoutingTableEntry newEntry(/*device=*/dev, /*dst=*/dst, /*validSeqNo=*/true, /*seqno=*/
			...
			/*iface=*/m_ipv4->GetAddress(
					m_ipv4->GetInterfaceForAddress(receiver), 0),/*hop=*/hop,
